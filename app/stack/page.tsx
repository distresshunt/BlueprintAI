      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-16">
        <div className="mb-16 text-center">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tighter text-white mb-6">
            The <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-800 to-blue-500">Founder's Stack</span>
          </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-7xl mx-auto">
                {categoryGroup.tools.map((tool, tIndex) => {
                  ...
                  return (
                    <div 
                      key={tIndex} 
                      className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 hover:border-zinc-700 transition-colors group flex flex-col h-full"
                    >
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <a 
                          ...
                          className="bg-zinc-800 hover:bg-zinc-800 text-zinc-300 hover:text-zinc-300 p-2 rounded-lg transition-all"
                      ...
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="mt-6 w-full py-3 bg-zinc-800 hover:bg-zinc-800 hover:text-black text-white rounded-xl text-sm font-bold transition-all text-center flex items-center justify-center gap-2 group-hover:"
                      >
