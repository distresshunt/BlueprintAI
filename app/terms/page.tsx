          ...
          <div className="space-y-8 text-sm leading-relaxed text-slate-300">
            <section>
              <h2 className="text-lg font-bold text-white mb-3 font-mono uppercase tracking-wider flex items-center gap-2">
                <span className="text-zinc-300">01.</span> Acceptance of Terms
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3 font-mono uppercase tracking-wider flex items-center gap-2">
                <span className="text-zinc-300">02.</span> Description of Service
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3 font-mono uppercase tracking-wider flex items-center gap-2">
                <span className="text-zinc-300">03.</span> User Accounts & Authentication
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3 font-mono uppercase tracking-wider flex items-center gap-2">
                <span className="text-zinc-300">04.</span> Intellectual Property & Content Ownership
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3 font-mono uppercase tracking-wider flex items-center gap-2">
                <span className="text-zinc-300">05.</span> Payments and Billing
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3 font-mono uppercase tracking-wider flex items-center gap-2">
                <span className="text-zinc-300">06.</span> Disclaimer of Warranties
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3 font-mono uppercase tracking-wider flex items-center gap-2">
                <span className="text-zinc-300">07.</span> Limitations of Liability
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3 font-mono uppercase tracking-wider flex items-center gap-2">
                <span className="text-zinc-300">08.</span> Governing Law
              </h2>
              <p>
