    ...
    <div className="relative group mt-4">
      <div className="absolute top-2 right-2 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all z-10">
        <button
          ...
          className="bg-zinc-800/80 hover:bg-zinc-700 text-zinc-300 border border-zinc-700 backdrop-blur-sm px-2 py-1.5 rounded-md flex items-center gap-1.5 text-xs font-semibold tracking-wide transition-all hover:"
        >
